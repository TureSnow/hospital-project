...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfiguration(UserService userService, RestfulAccessDeniedHandler restfulAccessDeniedHandler, RestAuthenticationEntryPoint restAuthenticationEntryPoint) {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf()// 由于使用的是JWT，我们这里不需要csrf
                ...
                .authenticated();
        // 禁用缓存
        httpSecurity.logout().logoutUrl("someLogOutUrlToFix");
        // 添加JWT filter
    ...
    public UserDetailsService userDetailsService() {
        ...
        return username -> {
            ...
            if (user != null) {
                ...
                permissionList.add(userService.getUserById(user.getId()).getRole());
