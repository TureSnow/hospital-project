    ...
    <el-aside width="200px" style="background-color: rgb(238, 241, 246);text-align: left;">
      ...
      <el-menu :default-openeds="['1']" >
        <el-submenu index="1" >
          ...
          <el-menu-item-group >
            <router-link to="/headNurse/beds" style="text-decoration: none"><el-menu-item index="1-1">本病房病床 </el-menu-item></router-link>
            <router-link to="/headNurse/wardNurses" style="text-decoration: none"><el-menu-item index="1-2" >本病房护士</el-menu-item></router-link>
            <router-link to="/headNurse/patients" style="text-decoration: none"><el-menu-item index="1-3" >本病房病人</el-menu-item></router-link>
        ...
        <el-menu-item index="2"><template slot="title"><i class="el-icon-message"></i>
          <router-link to="/headNurse/messages" style="text-decoration: none">通知</router-link></template>
        </el-menu-item>
